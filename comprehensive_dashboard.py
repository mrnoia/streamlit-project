...
# Category & Customer Segments Code Section
with st.expander("💻 Category & Customer Code", expanded=False):
    st.code('''
...
# Map & Regional Summary Code Section
with st.expander("💻 Map & Regional Code", expanded=False):
    st.code('''
...
# Time Series Analysis Code Section
with st.expander("💻 Time Series Code", expanded=False):
    st.code('''
# Daily Sales Pattern
daily_pattern = sales_data.groupby(sales_data['Date'].dt.dayofweek)['Sales'].mean().reset_index()
daily_pattern['Day'] = ['Mon', 'Tue', 'Wed', 'Thu', 'Fri', 'Sat', 'Sun']
...
# Insights & Data Table Code Section
with st.expander("💻 Insights & Data Table Code", expanded=False):
    st.code('''
